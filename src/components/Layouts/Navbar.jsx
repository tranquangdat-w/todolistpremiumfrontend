    ...
    <>
      ...
      <nav className="bg-white shadow z-10 px-8 py-2 fixed left-0 right-0 top-0 flex items-center justify-between">
        ...
        <div className='flex items-center w-[40%] gap-2 justify-center'>
          ...
          {/* Actions */}
          <button onClick={() => setOpenCreateBoard(true)} className="bg-blue-600 w-[20%] text-white px-4 py-1 rounded-lg flex justify-center items-center gap-1 hover:bg-blue-700">
            <Plus size={16} /> Tạo mới
          </button>

          {
            openCreateBoard && (
              <FormCreateBoard setOpen={setOpenCreateBoard} open={openCreateBoard} />
            )
          }
